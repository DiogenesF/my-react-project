...
import Background from "./styles/computer-science.png";

function MyContent() {

    return (
        <>
            <div style={{ background: "url(" + Background + ") no-repeat center center fixed", backgroundSize: "cover", height: "100%", width:"100%" }}>
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 text-center">
                            <h3 style={{ marginTop: "80px", color: "white" }}><strong>Be welcome to my webpage!!</strong></h3>
                        </div>
                    </div>
                    <div className="row">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-12 mt-4">
                            <h5 style={{ color: "white" }}><strong>This is a website that I created using React just to practice and
